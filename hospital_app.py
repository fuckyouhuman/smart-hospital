...
<style>
    ...
    header[data-testid="stHeader"] {display: nonel;}
...
<div style="background: linear-gradient(
    135deg,#1e3a8a 0%, #1a56db 60%,#0ea5e9 100%);
    padding: 3rem 2rem 2.5rem;margin: 1-rem -1rem 2rem;
    text-allign: center;">
    <div style="font-size: 14px;font-weight: 500;color: white;
    text-transform: uppercase; letter-spacing: 0.1rem;margin-bottom: 12px">
